...
```bash
# Load one by reading it. Nothing installs it.
cat skills/sandbox/SKILL.md

# Claude Code discovers skills under .claude/skills, not a bare skills/ directory.
# To have it find these, expose them once:
