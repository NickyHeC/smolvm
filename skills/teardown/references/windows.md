...
**Not re-run by this packet.** Every command and output below was executed once on Windows 11
Home build 26200 x86_64 against smolvm v1.14.2 and is reproduced unchanged. The Windows host was
not available when this packet was written.
