...
case "$kernel" in
    ...
    *)
        ...
        blocked=1
        note "this script covers macOS and Linux. Windows packs an image fine and --from-vm was never run there; see references/windows.md, written from a run and not re-run by this packet."
        ;;
esac
