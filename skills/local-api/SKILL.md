...
- **Linux x86_64**: verified in the material behind this packet, over both transports, not re-run
  here.
- **Windows x86_64**: `references/windows.md`, **not re-run**. Loopback TCP only, no Unix socket
  form was ever attempted, and **400 and 404 return empty bodies there**, so a wrong field name
