...
case "$kernel" in
    ...
    *)
        ...
        note "this script covers macOS and Linux. On Windows a stopped machine does not start again (smolvm#1196), and the WHP device budget caps you at four -v mounts, three when a port is published. See references/windows.md, written from a run and not re-run by this packet."
        ;;
esac
